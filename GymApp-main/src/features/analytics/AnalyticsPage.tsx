    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">124,500 kg</div>
      ...
      <Card className="h-[400px] flex items-center justify-center border-dashed">
        <div className="text-center space-y-2">
          <TrendingUp className="h-12 w-12 text-muted-foreground mx-auto opacity-20" />
          <p className="text-muted-foreground">Detailed charts and progress tracking coming soon.</p>
        </div>
      </Card>
    </div>
  );
